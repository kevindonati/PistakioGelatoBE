...
API REST per l'e-commerce di [**Pistakio Gelato**](https://pistakiogelato.com), sviluppata con Spring Boot.
...
Frontend: [repository separata](https://github.com/kevindonati/PistakioGelatoFE), sviluppata con React + TypeScript + Vite.
