...
public class AuthController {
    ...
    public UserResponseDTO register(
        ...
        return new UserResponseDTO(savedUser.getId(), savedUser.getName(), savedUser.getSurname(), savedUser.getEmail(), savedUser.getPhone(), savedUser.getRole(), savedUser.isEnabled());
    }
